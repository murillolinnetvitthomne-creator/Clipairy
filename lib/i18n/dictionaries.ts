...
Tap below to generate your first product ad free.`,
  ...
  account: {
    ...
    demoNote: 'Demo environment: clicking a plan simulates a successful purchase and grants credits — no real charge.',
    perUse: '/ use',
    perMonth: '/ month',
  },
  cta: {
...
点击下方,免费生成你的第一条产品广告。`,
  ...
  account: {
    ...
    mostPopular: '最受欢迎',
    current: '当前方案',
    demoNote: '演示环境：点击方案将直接模拟购买成功并发放次数，不会真实扣款。',
    perUse: '/ 次',
    perMonth: '/ 月',
  },
  cta: {
...
Ketuk di bawah untuk membuat iklan produk pertamamu gratis.`,
  ...
  account: {
    ...
    demoNote: 'Lingkungan demo: klik paket akan mensimulasikan pembelian sukses dan memberi kredit — tanpa penagihan nyata.',
    perUse: '/ pakai',
    perMonth: '/ bulan',
  },
  cta: {
...
แตะด้านล่างเพื่อสร้างโฆษณาสินค้าชิ้นแรกของคุณฟรี`,
  ...
  plans: {
    payg: { name: 'จ่ายตามครั้ง', description: 'ใช้เป็นครั้งคราว ซื้อจำนวนครั้งตามต้องการ', cta: 'ซื้อ 10 ครั้ง', features: ['สร้างวิดีโอ 10 ครั้งแบบซื้อครั้งเดียว', 'ขั้นตอน 12 ขั้นครบ', 'ส่งออก HD 1080P', 'จำนวนครั้งไม่หมดอายุ'] },
  ...
  account: {
    ...
    demoNote: 'สภาพแวดล้อมสาธิต: คลิกแพ็กเกจจะจำลองการซื้อสำเร็จและให้จำนวนครั้ง โดยไม่มีการเรียกเก็บเงินจริง',
    perUse: '/ ครั้ง',
    perMonth: '/ เดือน',
  },
  cta: {
...
Chạm bên dưới để tạo quảng cáo sản phẩm đầu tiên miễn phí.`,
  ...
  account: {
    ...
    noPlanDesc: 'Bạn chưa mua gói nào nên chưa thể dùng thử tạo video. Chọn gói bên dưới để mở khóa.',
    ...
    demoNote: 'Môi trường demo: nhấn gói sẽ mô phỏng mua thành công và cấp lượt — không tính phí thật.',
    perUse: '/ lượt',
    perMonth: '/ tháng',
  },
  cta: {
