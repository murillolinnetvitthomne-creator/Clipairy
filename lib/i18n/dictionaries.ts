...
Tap below to generate your first product ad free.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Pay as you go', price: '$5', unit: '/ video', desc: 'Sellers who post occasionally or want to test the waters', features: ['One full ad per generation', 'Full 12-step workflow', 'Standard resolution export', 'Multi-platform format'], cta: 'Generate per video' },
      { name: 'Growth', price: '$29', unit: '/ month', desc: 'Merchants running ongoing campaigns needing volume', features: ['120 videos per month', 'HD export + no watermark', 'Priority generation queue', 'Viral framework template library', 'Team collaboration seats'], cta: 'Start subscription' },
      { name: 'Team', price: '$199', unit: '', desc: 'Short-video marketing teams and agencies', features: ['Unlimited videos', 'API access & batch generation', 'Custom brand styles', 'Dedicated account manager', 'SLA guarantee'], cta: 'Contact us' },
    ] as MarketingPlan[],
  },
  plans: {
    ...
    team: { name: 'Team', description: 'Team collaboration, massive output.', cta: 'Subscribe to Team', features: ['Unlimited video generations', '5 team seats', 'Brand asset library & templates', 'Dedicated success manager', 'API access'] },
  ...
  account: {
    ...
    demoNote: 'Payments are securely processed by PayPal. Access is granted only after payment succeeds.',
    perUse: '/ use',
    perMonth: '/ month',
    ...
    payWith: 'Pay securely with PayPal',
    close: 'Close',
    paypalNotReady: 'PayPal subscriptions are not configured yet. Please try again later.',
...
点击下方,免费生成你的第一条产品广告。`,
  ...
  pricing: {
    ...
    mostPopular: '最受欢迎',
    plans: [
      { name: '按次付费', price: '$5', unit: '/ 条视频', desc: '偶尔出片、想先试试效果的卖家', features: ['单条完整广告成片', '12 步全流程处理', '标准清晰度导出', '多平台格式适配'], cta: '按次生成' },
      { name: '增长订阅', price: '$29', unit: '/ 月', desc: '持续投放、需要大量素材的商家', features: ['每月 120 条视频额度', '高清导出 + 去水印', '优先生成队列', '爆款框架模板库', '团队协作席位'], cta: '开始订阅' },
      { name: '团队版', price: '$199', unit: '', desc: '短视频营销团队与代运营机构', features: ['无限视频额度', 'API 接入与批量生成', '品牌风格自定义', '专属客户经理', 'SLA 保障'], cta: '联系我们' },
    ],
  },
  plans: {
    ...
    team: { name: '团队版', description: '团队协作，海量产出。', cta: '订阅团队版', features: ['不限次数视频生成', '5 个团队席位', '品牌素材库与模板', '专属客户成功经理', 'API 接入支持'] },
  },
  auth: {
    signUpTitle: '创建你的账户',
    signInTitle: '欢迎回来',
  ...
  account: {
    ...
    mostPopular: '最受欢迎',
    current: '当前方案',
    demoNote: '支付由 PayPal 安全处理，仅在付款成功后才会开通权益。',
    perUse: '/ 次',
    perMonth: '/ 月',
    ...
    payWith: '使用 PayPal 安全支付',
    close: '关闭',
    paypalNotReady: 'PayPal 订阅尚未配置完成，请稍后再试。',
...
Ketuk di bawah untuk membuat iklan produk pertamamu gratis.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Bayar per pakai', price: '$5', unit: '/ video', desc: 'Penjual yang sesekali posting atau ingin coba dulu', features: ['Satu iklan penuh per generasi', 'Alur 12 langkah lengkap', 'Ekspor resolusi standar', 'Format multi-platform'], cta: 'Buat per video' },
      { name: 'Growth', price: '$29', unit: '/ bulan', desc: 'Pedagang kampanye rutin yang butuh volume', features: ['120 video per bulan', 'Ekspor HD + tanpa watermark', 'Antrean generasi prioritas', 'Perpustakaan templat viral', 'Kursi kolaborasi tim'], cta: 'Mulai langganan' },
      { name: 'Tim', price: '$199', unit: '', desc: 'Tim marketing video pendek dan agensi', features: ['Video tanpa batas', 'Akses API & generasi massal', 'Gaya brand kustom', 'Manajer akun khusus', 'Jaminan SLA'], cta: 'Hubungi kami' },
    ],
  },
  plans: {
    ...
    team: { name: 'Tim', description: 'Kolaborasi tim, output besar.', cta: 'Langganan Tim', features: ['Generasi video tanpa batas', '5 kursi tim', 'Perpustakaan aset & templat brand', 'Manajer sukses khusus', 'Akses API'] },
  },
  auth: {
  ...
  account: {
    ...
    demoNote: 'Pembayaran diproses dengan aman oleh PayPal. Akses hanya diberikan setelah pembayaran berhasil.',
    perUse: '/ pakai',
    perMonth: '/ bulan',
    ...
    payWith: 'Bayar dengan aman via PayPal',
    close: 'Tutup',
    paypalNotReady: 'Langganan PayPal belum dikonfigurasi. Silakan coba lagi nanti.',
...
แตะด้านล่างเพื่อสร้างโฆษณาสินค้าชิ้นแรกของคุณฟรี`,
  ...
  pricing: {
    ...
    mostPopular: 'ยอดนิยม',
    plans: [
      { name: 'จ่ายตามครั้ง', price: '$5', unit: '/ วิดีโอ', desc: 'ผู้ขายที่โพสต์เป็นครั้งคราวหรืออยากลองก่อน', features: ['โฆษณาเต็มหนึ่งชิ้นต่อการสร้าง', 'ขั้นตอน 12 ขั้นครบ', 'ส่งออกความละเอียดมาตรฐาน', 'รองรับหลายแพลตฟอร์ม'], cta: 'สร้างตามครั้ง' },
      { name: 'Growth', price: '$29', unit: '/ เดือน', desc: 'ร้านค้าที่ยิงโฆษณาต่อเนื่องและต้องการปริมาณ', features: ['120 วิดีโอต่อเดือน', 'ส่งออก HD + ไม่มีลายน้ำ', 'คิวสร้างลำดับต้น', 'คลังเทมเพลตไวรัล', 'ที่นั่งทำงานเป็นทีม'], cta: 'เริ่มสมัครสมาชิก' },
      { name: 'ทีม', price: '$199', unit: '', desc: 'ทีมการตลาดวิดีโอสั้นและเอเจนซี', features: ['วิดีโอไม่จำกัด', 'เข้าถึง API และสร้างจำนวนมาก', 'ปรับสไตล์แบรนด์เอง', 'ผู้จัดการบัญชีเฉพาะ', 'รับประกัน SLA'], cta: 'ติดต่อเรา' },
    ],
  },
  plans: {
    ...
    team: { name: 'ทีม', description: 'ทำงานเป็นทีม ผลิตจำนวนมาก', cta: 'สมัครแพ็กเกจทีม', features: ['สร้างวิดีโอไม่จำกัด', 'ที่นั่งทีม 5 ที่', 'คลังสื่อและเทมเพลตแบรนด์', 'ผู้จัดการดูแ����เฉพาะ', 'รองรับการเชื่อม API'] },
  },
  auth: {
  ...
  account: {
    ...
    demoNote: 'การชำระเงินดำเนินการอย่างปลอดภัยโดย PayPal จะเปิดใช้งานสิทธิ์หลังชำระเงินสำเร็จเท่านั้น',
    perUse: '/ ครั้ง',
    perMonth: '/ เดือน',
    ...
    payWith: 'ชำระเงินอย่างปลอดภัยด้วย PayPal',
    close: 'ปิด',
    paypalNotReady: 'ยังไม่ได้ตั้งค่าการสมัครสมาชิก PayPal กรุณาลองใหม่ภายหลัง',
...
const vi: Dict = {
  ...
  studio: {
    ...
    gateAnonDesc: 'Dùng thử chỉ dành cho người dùng có gói đang hoạt động. Vui lòng đ��ng nhập hoặc đăng ký trước.',
...
Chạm bên dưới để tạo quảng cáo sản phẩm đầu tiên miễn phí.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Trả theo lượt', price: '$5', unit: '/ video', desc: 'Người bán đăng thỉnh thoảng hoặc muốn thử trước', features: ['Một quảng cáo hoàn chỉnh mỗi lần tạo', 'Đủ quy trình 12 bước', 'Xuất độ phân giải tiêu chuẩn', 'Định dạng đa nền tảng'], cta: 'Tạo theo lượt' },
      { name: 'Growth', price: '$29', unit: '/ tháng', desc: 'Nhà bán chạy chiến dịch liên tục, cần số lượng', features: ['120 video mỗi tháng', 'Xuất HD + không watermark', 'Hàng đợi ưu tiên', 'Thư viện mẫu viral', 'Ghế cộng tác nhóm'], cta: 'Bắt đầu đăng ký' },
      { name: 'Nhóm', price: '$199', unit: '', desc: 'Đội marketing video ngắn và agency', features: ['Video không giới hạn', 'Truy cập API & tạo hàng loạt', 'Tùy chỉnh phong cách thương hiệu', 'Quản lý tài khoản riêng', 'Cam kết SLA'], cta: 'Liên hệ' },
    ],
  },
  plans: {
    ...
    growth: { name: 'Growth', description: 'Giá trị tốt cho nhà bán nh�� và vừa.', cta: 'Đăng ký Growth', features: ['120 lượt tạo video / tháng', 'Đủ quy trình 12 bước', 'Xuất 4K + không watermark', 'Đa nền tảng một chạm', 'Hàng đợi ưu tiên'] },
    team: { name: 'Nhóm', description: 'Cộng tác nhóm, sản lượng lớn.', cta: 'Đăng ký gói Nhóm', features: ['Tạo video không giới hạn', '5 ghế nhóm', 'Thư viện tư liệu & mẫu thương hiệu', 'Quản lý thành công riêng', 'Hỗ trợ tích hợp API'] },
  },
  auth: {
  ...
  account: {
    ...
    demoNote: 'Thanh toán được PayPal xử lý an toàn. Quyền lợi chỉ được cấp sau khi thanh toán thành công.',
    perUse: '/ lượt',
    perMonth: '/ tháng',
    ...
    payWith: 'Thanh toán an toàn bằng PayPal',
    close: 'Đóng',
    paypalNotReady: 'Gói đăng ký PayPal chưa được cấu hình. Vui lòng thử lại sau.',
