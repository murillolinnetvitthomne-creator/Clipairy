...
Tap below to generate your first product ad free.`,
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: 'Growth', price: '$29', unit: '/ month', desc: 'Merchants running ongoing campaigns needing volume', features: ['30 videos per month', 'HD export + no watermark', 'Priority generation queue', 'Viral framework template library', 'Team collaboration seats'], cta: 'Start subscription' },
  ...
  plans: {
    payg: { name: 'Pay as you go', description: 'Occasional use, buy one generation on demand.', cta: 'Buy 1 generation', features: ['1 video generation credit', 'Full 12-step workflow', '1080P HD export', 'Credit never expires'] },
  ...
  account: {
    ...
    secureCheckout: 'Secure payment powered by Stripe. Access is granted only after payment is confirmed.',
    paymentSuccess: 'Payment received. Your access will appear as soon as Stripe confirms it.',
    paymentCancelled: 'Checkout was cancelled. You have not been charged.',
...
点击下方,免费生成你的第一条产品广告。`,
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: '增长订阅', price: '$29', unit: '/ 月', desc: '持续投放、需要大量素材的商家', features: ['每月 30 条视频额度', '高清导出 + 去水印', '优先生成队列', '爆款框架模板库', '团队协作席位'], cta: '开始订阅' },
      { name: '团队版', price: '定制', unit: '', desc: '短视频营销团队与代运营机构', features: ['无限视频额度', 'API 接入与批量生成', '品牌风格自定义', '专属客户经理', 'SLA 保障'], cta: '联系我们' },
    ],
  },
  plans: {
    payg: { name: '按次付费', description: '偶尔使用，按需购买单次生成。', cta: '购买 1 次', features: ['1 次视频生成额度', '全部 12 步智能工作流', '1080P 高清导出', '额度永久有效'] },
  ...
  account: {
    ...
    mostPopular: '最受欢迎',
    current: '当前方案',
    secureCheckout: '由 Stripe 提供安全支付。仅在付款确认后开通权益。',
    paymentSuccess: '已收到付款，Stripe 确认后权益将自动到账。',
    paymentCancelled: '支付已取消，未产生扣款。',
...
Ketuk di bawah untuk membuat iklan produk pertamamu gratis.`,
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: 'Growth', price: '$29', unit: '/ bulan', desc: 'Pedagang kampanye rutin yang butuh volume', features: ['30 video per bulan', 'Ekspor HD + tanpa watermark', 'Antrean generasi prioritas', 'Perpustakaan templat viral', 'Kursi kolaborasi tim'], cta: 'Mulai langganan' },
  ...
  plans: {
    payg: { name: 'Bayar per pakai', description: 'Beli satu generasi sesuai kebutuhan.', cta: 'Beli 1 generasi', features: ['1 kredit generasi video', 'Alur 12 langkah lengkap', 'Ekspor HD 1080P', 'Kredit tanpa kedaluwarsa'] },
  ...
  account: {
    ...
    secureCheckout: 'Pembayaran aman oleh Stripe. Akses diberikan hanya setelah pembayaran dikonfirmasi.',
    paymentSuccess: 'Pembayaran diterima. Akses akan aktif setelah dikonfirmasi Stripe.',
    paymentCancelled: 'Pembayaran dibatalkan. Anda tidak dikenai biaya.',
...
แตะด้านล่างเพื่อสร้างโฆษณาสินค้าชิ้นแรกของคุณฟรี`,
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: 'Growth', price: '$29', unit: '/ เดือน', desc: 'ร้านค้าที่ยิงโฆษณาต่อเนื่องและต้องการปริมาณ', features: ['30 วิดีโอต่อเดือน', 'ส่งออก HD + ไม่มีลายน้ำ', 'คิวสร้างลำดับต้น', 'คลังเทมเพลตไวรัล', 'ที่นั่งทำงานเป็นทีม'], cta: 'เริ่มสมัครสมาชิก' },
  ...
  plans: {
    payg: { name: 'จ่ายตามครั้ง', description: 'ซื้อการสร้างหนึ่งครั้งตามต้องการ', cta: 'ซื้อ 1 ครั้ง', features: ['เครดิตสร้างวิดีโอ 1 ครั้ง', 'ขั้นตอน 12 ขั้นครบ', 'ส่งออก HD 1080P', 'เครดิตไม่หมดอายุ'] },
  ...
  account: {
    ...
    secureCheckout: 'ชำระเงินอย่างปลอดภัยโดย Stripe สิทธิ์จะเปิดหลังยืนยันการชำระเงินเท่านั้น',
    paymentSuccess: 'ได้รับการชำระเงินแล้ว สิทธิ์จะเปิดเมื่อ Stripe ยืนยัน',
    paymentCancelled: 'ยกเลิกการชำระเงินแล้ว ไม่มีการเรียกเก็บเงิน',
...
Chạm bên dưới để tạo quảng cáo sản phẩm đầu tiên miễn phí.`,
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: 'Growth', price: '$29', unit: '/ tháng', desc: 'Nhà bán chạy chiến dịch liên tục, cần số lượng', features: ['30 video mỗi tháng', 'Xuất HD + không watermark', 'Hàng đợi ưu tiên', 'Thư viện mẫu viral', 'Ghế cộng tác nhóm'], cta: 'Bắt đầu đăng ký' },
  ...
  plans: {
    payg: { name: 'Trả theo lượt', description: 'Mua một lượt tạo video theo nhu cầu.', cta: 'Mua 1 lượt', features: ['1 lượt tạo video', 'Đủ quy trình 12 bước', 'Xuất HD 1080P', 'Lượt không hết hạn'] },
  ...
  account: {
    ...
    secureCheckout: 'Thanh toán an toàn qua Stripe. Quyền truy cập chỉ được cấp sau khi xác nhận thanh toán.',
    paymentSuccess: 'Đã nhận thanh toán. Quyền truy cập sẽ hiện sau khi Stripe xác nhận.',
    paymentCancelled: 'Thanh toán đã bị hủy. Bạn không bị tính phí.',
