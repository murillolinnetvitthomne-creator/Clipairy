...
Tap below to generate your first product ad free.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Pay as you go', price: '$3', unit: '/ video', desc: 'Sellers who post occasionally or want to test the waters', features: ['One full ad per generation', 'Full 12-step workflow', 'Standard resolution export', 'Multi-platform format'], cta: 'Generate per video' },
      { name: 'Growth', price: '$19', unit: '/ month', desc: 'Merchants running ongoing campaigns needing volume', features: ['30 videos per month', 'HD export + no watermark', 'Priority generation queue', 'Viral framework template library', 'Team collaboration seats'], cta: 'Start subscription' },
      { name: 'Team', price: 'Custom', unit: '', desc: 'Short-video marketing teams and agencies', features: ['Unlimited videos', 'API access & batch generation', 'Custom brand styles', 'Dedicated account manager', 'SLA guarantee'], cta: 'Contact us' },
    ] as MarketingPlan[],
  },
  plans: {
    payg: { name: 'Pay as you go', description: 'Occasional use, buy generations on demand.', cta: 'Buy 10 credits', features: ['10 one-time video generations', 'Full 12-step workflow', '1080P HD export', 'Credits never expire'] },
...
const zh: Dict = {
  ...
  studio: {
    ...
    steps: [
      ...
      { title: '画面分解', desc: '分析镜头、节奏、场景与产品展示方式', tools: ['gpt-5.5 Vision', 'Gemini Video'] },
...
点击下方,免费生成你的第一条产品广告。`,
  ...
  pricing: {
    ...
    mostPopular: '最受欢迎',
    plans: [
      { name: '按次付费', price: '$3', unit: '/ 条视频', desc: '偶尔出片、想先试试效果的卖家', features: ['单条完整广告成片', '12 步全流程处理', '标准清晰度导出', '多平台格式适配'], cta: '按次生成' },
      { name: '增长订阅', price: '$19', unit: '/ 月', desc: '持续投放、需要大量素材的商家', features: ['每月 30 条视频额度', '高清导出 + 去水印', '优先生成队列', '爆款框架模板库', '团队协作席位'], cta: '开始订阅' },
      { name: '团队版', price: '定制', unit: '', desc: '短视频营销团队与代运营机构', features: ['无限视频额度', 'API 接入与批量生成', '品牌风格自定义', '专属客户经理', 'SLA 保障'], cta: '联系我们' },
    ],
  },
  plans: {
    payg: { name: '按次付费', description: '偶尔使用，按需购买生成次数。', cta: '购买 10 次', features: ['一次性 10 次视频生成', '全部 12 步智能工作流', '1080P 高清导出', '次数永久有效'] },
...
Ketuk di bawah untuk membuat iklan produk pertamamu gratis.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Bayar per pakai', price: '$3', unit: '/ video', desc: 'Penjual yang sesekali posting atau ingin coba dulu', features: ['Satu iklan penuh per generasi', 'Alur 12 langkah lengkap', 'Ekspor resolusi standar', 'Format multi-platform'], cta: 'Buat per video' },
      { name: 'Growth', price: '$19', unit: '/ bulan', desc: 'Pedagang kampanye rutin yang butuh volume', features: ['30 video per bulan', 'Ekspor HD + tanpa watermark', 'Antrean generasi prioritas', 'Perpustakaan templat viral', 'Kursi kolaborasi tim'], cta: 'Mulai langganan' },
      { name: 'Tim', price: 'Kustom', unit: '', desc: 'Tim marketing video pendek dan agensi', features: ['Video tanpa batas', 'Akses API & generasi massal', 'Gaya brand kustom', 'Manajer akun khusus', 'Jaminan SLA'], cta: 'Hubungi kami' },
    ],
  },
  plans: {
    payg: { name: 'Bayar per pakai', description: 'Pemakaian sesekali, beli generasi sesuai kebutuhan.', cta: 'Beli 10 kredit', features: ['10 generasi video sekali beli', 'Alur 12 langkah lengkap', 'Ekspor HD 1080P', 'Kredit tanpa kedaluwarsa'] },
...
แตะด้านล่างเพื่อสร้างโฆษณาสินค้าชิ้นแรกของคุณฟรี`,
  ...
  pricing: {
    ...
    mostPopular: 'ยอดนิยม',
    plans: [
      { name: 'จ่ายตามครั้ง', price: '$3', unit: '/ วิดีโอ', desc: 'ผู้ขายที่โพสต์เป็นครั้งคราวหรืออยากลองก่อน', features: ['โฆษณาเต็มหนึ่งชิ้นต่อการสร้าง', 'ขั้นตอน 12 ขั้นครบ', 'ส่งออกความละเอียดมาตรฐาน', 'รองรับหลายแพลตฟอร์ม'], cta: 'สร้างตามครั้ง' },
      { name: 'Growth', price: '$19', unit: '/ เดือน', desc: 'ร้านค้าที่ยิงโฆษณาต่อเนื่องและต้องการปริมาณ', features: ['30 วิดีโอต่อเดือน', 'ส่งออก HD + ไม่มีลายน้ำ', 'คิวสร้างลำดับต้น', 'คลังเทมเพลตไวรัล', 'ที่นั่งทำงานเป็นทีม'], cta: 'เริ่มสมัครสมาชิก' },
      { name: 'ทีม', price: 'กำหนดเอง', unit: '', desc: 'ทีมการตลาดวิดีโอสั้นและเอเจนซี', features: ['วิดีโอไม่จำกัด', 'เข้าถึง API และสร้างจำนวนมาก', 'ปรับสไตล์แบรนด์เอง', 'ผู้จัดการบัญชีเฉพาะ', 'รับประกัน SLA'], cta: 'ติดต่อเรา' },
    ],
  },
  plans: {
    payg: { name: 'จ่ายตามครั้ง', description: 'ใช้เป็นครั้งคราว ซื้อจำนวนครั้งตามต้องการ', cta: 'ซื้อ 10 ครั้ง', features: ['สร้างวิดีโอ 10 ครั้งแบบซ���้อครั้งเดียว', 'ขั้นตอน 12 ขั้นครบ', 'ส่งออก HD 1080P', 'จำนวนครั้งไม่หมดอายุ'] },
...
Chạm bên dưới để tạo quảng cáo sản phẩm đầu tiên miễn phí.`,
  ...
  pricing: {
    ...
    plans: [
      { name: 'Trả theo lượt', price: '$3', unit: '/ video', desc: 'Người bán đăng thỉnh thoảng hoặc muốn thử trước', features: ['Một quảng cáo hoàn chỉnh mỗi lần tạo', 'Đủ quy trình 12 bước', 'Xuất độ phân giải tiêu chuẩn', 'Định dạng đa nền tảng'], cta: 'Tạo theo lượt' },
      { name: 'Growth', price: '$19', unit: '/ tháng', desc: 'Nhà bán chạy chiến dịch liên tục, cần số lượng', features: ['30 video mỗi tháng', 'Xuất HD + không watermark', 'Hàng đợi ưu tiên', 'Thư viện mẫu viral', 'Ghế cộng tác nhóm'], cta: 'Bắt đầu đăng ký' },
      { name: 'Nhóm', price: 'Tùy chỉnh', unit: '', desc: 'Đội marketing video ngắn và agency', features: ['Video không giới hạn', 'Truy cập API & tạo hàng loạt', 'Tùy chỉnh phong cách thương hiệu', 'Quản lý tài khoản riêng', 'Cam kết SLA'], cta: 'Liên hệ' },
    ],
  },
  plans: {
    payg: { name: 'Trả theo lượt', description: 'Dùng thỉnh thoảng, mua lượt tạo theo nhu cầu.', cta: 'Mua 10 lượt', features: ['10 lượt tạo video mua một lần', 'Đủ quy trình 12 bước', 'Xuất HD 1080P', 'Lượt không hết hạn'] },
    growth: { name: 'Growth', description: 'Giá trị tốt cho nhà bán nhỏ và vừa.', cta: 'Đăng ký Growth', features: ['120 lượt tạo video / tháng', 'Đủ quy trình 12 bước', 'Xuất 4K + không watermark', 'Đa nền tảng một chạm', 'Hàng đợi ưu tiên'] },
